...
) ENGINE = InnoDB AUTO_INCREMENT = 4825 COMMENT = '文件表; 软删除未启用;';
...
INSERT INTO `student` (`id`,`studentId`,`name`,`gender`,`dateOfBirth`,`classId`,`level`,`bodyHeight`,`studentStatus`,`remarks`,`operation`,`operationByUserId`,`operationByUser`,`operationAt`) VALUES (176,'10002222',NULL,NULL,NULL,'111',NULL,NULL,NULL,NULL,'jhInsert','admin','系统管理员','2022-08-21T21:44:17+08:00');
